...
WBBLANG['ru']= CURLANG = {
	...
	fontcolor: "צבע טקסט",
	fontsize: "גודל הטקסט",
	fontfamily: "גופן הטקסט",
	fs_verysmall: "קטן מאוד",
	fs_small: "קטן",
	fs_normal: "רגיל",
	fs_big: "גדול",
	fs_verybig: "&#1506;&#1504;&#1511;",
	smilebox: "&#1492;&#1499;&#1504;&#1505; &#1505;&#1502;&#1497;&#1497;&#1500;&#1497;",
	video: "&#1492;&#1499;&#1504;&#1505; &#1493;&#1493;&#1497;&#1491;&#1488;&#1493;",
	removeFormat: "להוריד פורמט",
	
	modal_link_title: "&#1492;&#1499;&#1504;&#1505;&#1514; &#1511;&#1497;&#1513;&#1493;&#1512;",
	modal_link_text: "שם הקישור",
	modal_link_url: "כתובת הקישור",
	modal_email_text: "שם המייל",
	modal_email_url: "כתובת המייל",
	modal_link_tab1: "&#1492;&#1499;&#1504;&#1505; &#1511;&#1497;&#1513;&#1493;&#1512;",
	
	modal_img_title: "&#1492;&#1499;&#1504;&#1505; &#1514;&#1502;&#1493;&#1504;&#1492;",
	modal_img_tab1: "דרך קישור",
	modal_img_tab2: "דרך המחשב",
	modal_imgsrc_text: "&#1492;&#1499;&#1504;&#1505; &#1511;&#1497;&#1513;&#1493;&#1512; &#1500;&#1514;&#1502;&#1493;&#1504;&#1492;",
	modal_img_btn: "בחר קבצים להעלאה",
	add_attach: "הוסף קובץ מצורף",
	
	modal_video_text: "&#1492;&#1499;&#1504;&#1505; &#1499;&#1514;&#1493;&#1489;&#1514; &#1511;&#1497;&#1513;&#1493;&#1512;",
	...
	validation_err: "&#1492;&#1504;&#1514;&#1493;&#1504;&#1497;&#1501; &#1513;&#1492;&#1493;&#1511;&#1513;&#1493; &#1500;&#1488; &#1504;&#1499;&#1493;&#1504;&#1497;&#1501;",
	error_onupload: "&#1500;&#1488; &#1504;&#1497;&#1514;&#1503; &#1500;&#1492;&#1506;&#1500;&#1493;&#1514; &#1488;&#1514; &#1492;&#1511;&#1493;&#1489;&#1509;",
	
	fileupload_text1: "גרור קבצים לכאן",
	fileupload_text2: "או",
...
//			toolbar:			false,
			//img upload config 
			imgupload:		false,
			img_uploadurl:		"../functions/iupload.php",
			img_maxwidth:		1800,
			img_maxheight:		1800,
			hotkeys:			true,
			showHotkeys:		true,
			...
			buttons: 			"bold,italic,underline,|,img,video,link,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyright,justifycenter,justifyleft",
			allButtons: {
				bold : {
					title: CURLANG.bold,
				...
				link : {
					...
					transform : {
						'<a href="{URL}" target="_blank" class="noload">{SELTEXT}</a>':"[url={URL}]{SELTEXT}[/url]",
						'<a href="{URL}" target="_blank" class="noload">{URL}</a>':"[url]{URL}[/url]"
					}
				},
				img : {
					title: CURLANG.img,
				...
				code : {
					...
					onlyClearText: true,
					transform : {
						'<div class="codewrap"><div class="codemain">{SELTEXT}</div></div>':"[code]{SELTEXT}[/code]"
					}
				},
				offtop : {
				...
				video: {
					...
					transform: {
						'<iframe src="http://www.youtube.com/embed/{SRC}" width="560" height="315" frameborder="0"></iframe>':'[video]{SRC}[/video]'
					}
				},
	...
	$.wysibb.prototype = {
		...
		build: function() {
			...
			this.$editor.append('<span class="powered">Powered by <a href="http://www.wysibb.com" target="_blank" class="noload">WysiBB</a></span>');
